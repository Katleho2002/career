    ...
    <x-guest>
        <form method="POST" action="{{ route('register') }}" class="form-container">
            ...
            <div class="form-group">
                <!-- Full Name -->
                <div>
                    <x-input-label for="name" class="input-label" :value="__('Full Name')" />
            ...
            <div class="form-group">
                ...
                <!-- National ID -->
                <div>
                    <x-input-label for="national_id" class="input-label" :value="__('National ID')" />
                    <x-text-input id="national_id" class="input-field" type="number" min="0" name="national_id" :value="old('national_id')" required />
                    <x-input-error :messages="$errors->get('national_id')" class="input-error" />
                </div>
            </div>
